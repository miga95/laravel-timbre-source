...
<main>
    <div class="w-75  mx-auto mt-10">
        <h2 class="text-center">557ème Vente sur Offre</h2>
        <hr class="w-25">
        <p class="text-center">La Vente sur Offre NO 255 est organisée par Lorem ipsum dolor
    ...
    <div class="container container-fluid d-flex justify-content-around mt-10">
        <div class="container d-flex justify-content-center">
            <div>
                <h3 class=" mb-3 text-center">France</h3>
        ...
        <div class="container d-flex justify-content-center">
            <div>
                <h3 class="mb-3 text-center">Colonie française</h3>
                <img src="{{asset('img/timbres/black-penny-timbre-rare-philatelie-investissement.jpg')}}" alt="" width="150px" >
                <div>
                    <ul class="mt-5">
                        <li>Ceres</li>
